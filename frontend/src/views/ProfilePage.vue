                ...
                <div class="profile-form-wrap-content">
                    ...
                    <div class="form-input-wrap">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane profile-settings fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                <div class="input-wrap">
                                    <div class="row m-0">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-2">
                                                ...
                                                <div class="position-relative">
                                                    ...
                                                    <input type="Password" class="form-control" placeholder="Enter Street 1" />
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-2">
                                                <label for="exampleFormControlInput1" class="form-label">Street 2</label>
                                                <div class="position-relative">

                                                    <input type="phone number" class="form-control" placeholder="Enter Street 2" />
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-2">
                                                ...
                                                <div class="position-relative">
                                                    ...
                                                    <input type="phone number" class="form-control" placeholder="Enter Suburb" />
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-2">
                                                ...
                                                <div class="position-relative">
                                                    ...
                                                    <input type="phone number" class="form-control" placeholder="Enter Pincode" />
